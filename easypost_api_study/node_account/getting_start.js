...
const api = new Easypost('EZTK5d8422e7c1464a13a437dfa3f9d9705egFFDL0xruaG3uXanf488Yg');
...
const shipment = await api.Shipment.create({         //这部分分为shipment object 和 rates object 具体需要再看
